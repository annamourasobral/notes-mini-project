        ...
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <img class="h-8 w-8"
                         src="https://ik.imagekit.io/laracasts/series/thumbnails/php-for-beginners.png?tr=w-106"
                         alt="PHP for beginners project">
                </div>
                            ...
                            <?php if ($_SESSION['user'] ?? false) : ?>
                                <button type="button"
                                    ...
                                    <img class="h-8 w-8 rounded-full"
                                         src="https://i1.wp.com/s3.amazonaws.com/laracasts/images/forum/avatars/default-avatar-7.png?ssl=1"
